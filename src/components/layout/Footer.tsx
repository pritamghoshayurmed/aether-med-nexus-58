        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-3">
              {/* Instagram */}
              <a aria-label="Instagram" href="#" className="w-8 h-8 flex items-center justify-center bg-neutral-800 rounded-md">
              ...
              {/* LinkedIn */}
              <a aria-label="LinkedIn" href="#" className="w-8 h-8 flex items-center justify-center bg-neutral-800 rounded-md">
